...
function setUTCHoursStart(date) {
...
async function extrair_campos_chave_acesso(chaveAcesso) {
  ...
  return {
    ...
    serie: parseInt(chaveAcesso.substring(22, 25), 10),
    numeroNFe: parseInt(chaveAcesso.substring(25, 34), 10),
    codigoNumerico: chaveAcesso.substring(34, 42),
    dvChave: chaveAcesso.substring(43, 44),
  };
}
